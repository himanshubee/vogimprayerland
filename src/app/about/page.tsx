  ...
  return (
    <>
      ...
      <section className="relative bg-ivory">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32 grid lg:grid-cols-[1.1fr_1fr] gap-16 items-start">
          <Reveal>
            <p className="eyebrow text-gold-deep">
              <span className="gold-rule mr-3" />
              Our Story
            </p>
            <h2 className="font-display text-4xl md:text-5xl text-midnight mt-5 leading-[1.05]">
              From a village in Porto Novo
              <br />
              <span className="italic">to the ends of the earth.</span>
            </h2>
            <div className="mt-8 space-y-5 text-midnight/80 leading-relaxed text-lg">
          ...
          <Reveal delay={0.1}>
            <div className="relative aspect-[4/5] max-w-sm mx-auto lg:sticky lg:top-32">
              ...
              <div className="relative w-full h-full overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  ...
                  <p className="mt-3 text-white/80 text-sm italic font-display">
      ...
      <section className="relative bg-ivory-dark">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32 grid md:grid-cols-2 gap-px bg-midnight/15">
          <Reveal>
            <div className="bg-ivory-dark p-10 lg:p-14">
              <p className="eyebrow text-gold-deep">Mission Statement</p>
              <h3 className="font-display text-3xl md:text-4xl text-midnight mt-4 leading-tight">
                By the power of the Holy Ghost — deliverance, healing &amp;
                restoration to families oppressed by the devil.
              </h3>
              <p className="mt-6 text-midnight/80 leading-relaxed">
          ...
          <Reveal delay={0.1}>
            <div className="bg-midnight text-ivory p-10 lg:p-14 h-full">
              ...
              <figure className="mt-10 border-l-2 border-gold pl-5">
                <blockquote className="font-display italic text-xl text-ivory/95 leading-snug">
      ...
      <section className="relative bg-ivory paper-grain">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          <Reveal>
            ...
            <h2 className="font-display text-4xl md:text-5xl text-midnight mt-5 leading-[1.05] max-w-2xl">
          ...
          <div className="mt-14 grid md:grid-cols-3 gap-px bg-midnight/15">
            {PILLARS.map((p, i) => (
              <Reveal key={p.title} delay={i * 0.08}>
                <article className="bg-ivory p-10 h-full flex flex-col">
                  <span className="font-display text-6xl text-gold-deep/90">
                    {p.no}
                  </span>
                  <h3 className="font-display text-3xl text-midnight mt-6">
                    {p.title}
                  </h3>
                  <p className="mt-4 text-midnight/70 leading-relaxed flex-1">
                    {p.body}
                  </p>
                </article>
              </Reveal>
      ...
      <section className="relative bg-midnight text-ivory overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20 lg:py-28 text-center">
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <Link
              href="/contact"
              className="btn-ghost text-ivory border-ivory/40 hover:text-midnight"
            >
              Visit the church
            </Link>
          </div>
